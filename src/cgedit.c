...
int main(int argc, char *argv[]) {
  ...
  if (cfg_file_exists(fname)) {
    ...
    snprintf(fname, sizeof(fname), "%s/cgedit.cfg", path_system_config_dir());
    if (cfg_readconfig(fname) < 0) {
      return(1);
    }
  }
  ...
  if (cfg_columns == 40) {
    ...
    print("\x12\x1f            \x92\x9e   cg\x96" "eDIT \x05" "3.0   \x12\x1f            ");
    print("\x12\x1f            \x92                \x12            ");
    ...
    print("                    \x12\x1f            \x92\x9e   cg\x96" "eDIT \x05" "3.0   \x12\x1f            \x0d");
    print("                    \x12\x1f            \x92                \x12            \x0d");
